...
public class CodeProcessor {
	...
	public HintStruct computeHint(ArrayList<Integer> theSecret, ArrayList<Integer> feeler) {
		...
		secretCopy = new ArrayList<Integer>(theSecret);
		feelerCopy = new ArrayList<Integer>(feeler);
		crossOutBlacks();
		crossOutWhites();
